...
if ($sisa_waktu <= 0) {
    ...
    unset($_SESSION['checkout'], $_SESSION['keranjang'], $_SESSION['start_time']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['bukti'])) {
    ...
    if (!$file || !in_array($ext, $allowed)) {
        ...
        if (move_uploaded_file($tmp, $filePath)) {
            ...
            // =========================
            // SIMPAN ORDER KE DATABASE DARI SESSION (KERANJANG)
            // =========================
            ...
            // Simpan setiap item ke order_items + kurangi stok
            ...
            echo "<div class='alert alert-success'>Bukti berhasil diupload. Pesanan dari keranjang tersimpan dan muncul di riwayat.</div>";
